...
/**
 * MailingListRequestContact Class Doc Comment
 *
 * @category Class
 ...
 */
class MailingListRequestContact implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MailingListRequest_contact';
    ...
    */
     ...
     * Sets email
     *
     * @param string|null $email The email address of the sender or organization. Usually used for replies or compliance purposes.
     *
     * @return self
     */
     ...
     * Sets company
     *
     * @param string|null $company The name of the organization sending the email.
     *
     * @return self
     */
