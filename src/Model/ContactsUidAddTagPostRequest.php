...
/**
 * ContactsUidAddTagPostRequest Class Doc Comment
 *
 * @category Class
 * @package  Segnivo\SDK
 * @author   OpenAPI Generator team
 ...
 */
class ContactsUidAddTagPostRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = '_contacts__uid__add_tag_post_request';
    ...
    */
     ...
     * Sets tag
     *
     * @param string|null $tag Tag for a contact.
     *
     * @return self
     */
