 ...
 */
class CampaignCreateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CampaignCreateRequest';
    ...
    {
        $this->setIfExists('mailListUid', $data ?? [], null);
    ...
    */
     ...
     * @return string|null
     */
    public function getMailListUid()
    {
        return $this->container['mailListUid'];
    }

    /**
     * Sets mailListUid
     *
     * @param string|null $mailListUid Unique identifier for the mailing list
     *
     * @return self
     */
    public function setMailListUid($mailListUid)
    {
        if (is_null($mailListUid)) {
            throw new \InvalidArgumentException('non-nullable mailListUid cannot be null');
        }
        $this->container['mailListUid'] = $mailListUid;
     ...
     * Sets subject
     *
     * @param string|null $subject Subject of the email campaign
     *
     * @return self
     */
     ...
     * Sets fromEmail
     *
     * @param string|null $fromEmail Sender's email address
     *
     * @return self
     */
     ...
     * Sets fromName
     *
     * @param string|null $fromName Sender's full name
     *
     * @return self
     */
     ...
     * Sets replyTo
     *
     * @param string|null $replyTo Email address for replies
     *
     * @return self
     */
